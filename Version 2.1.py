...
#pathApeljson = '/home/anastasios/Documents/ElectricalEngeneeringMasterDegree/MedicalProject/Data/apel23072.json'
#pathBerryCSV = '/home/anastasios/Documents/ElectricalEngeneeringMasterDegree/MedicalProject/Data/berry23072.csv'
#give the path for TEST DATA

PathTestApel = '/home/anastasios/Documents/ElectricalEngeneeringMasterDegree/MedicalProject/Data/apel23072.json'
PathTestBerry = '/home/anastasios/Documents/ElectricalEngeneeringMasterDegree/MedicalProject/Data/berry23072.csv'
...
def insertNewData(NewApelDataPath,NewBerryDataPath):
    ...
    print([i for i in range(len(dfNewBerry['time'])) if  pd.isna(dfNewBerry['time'][i]) == True])
